...
<div class="container">
    ...
    <div class="alert alert-success how_it_work" role="alert">
        ...
        <br>
        <br>
        - выберите Станцию, объект на Станции и тип произошедшего события
        <br>
        - нажмите на кнопку <b> "Создать тестовое событие" </b>
        <br>
    ...
    <div class="col-12">
        <form action="{{ route('sendMessage') }}" method="POST" style="display: flex; flex-wrap:wrap; ">
            ...
            <div class="col-md-3 offset-md-4 col-10 offset-1 mt-4">
                ...
                <input type="submit" class="btn btn-primary w-100" value="Создать тестовое событие">
